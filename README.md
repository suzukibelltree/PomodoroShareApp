...
## Supabase設定
新しい Supabase プロジェクトを使う場合は、ルートの `local.properties` に以下を設定してください。

```properties
SUPABASE_URL=https://<your-project-ref>.supabase.co
SUPABASE_ANON_KEY=<your-anon-key>
SUPABASE_EDGE_FUNCTION_URL=https://<your-project-ref>.functions.supabase.co/upload-profile
```

プロフィール画像アップロードは `upload-profile` Edge Function を参照しているため、新しいプロジェクト側にも同名 Function のデプロイが必要です。
