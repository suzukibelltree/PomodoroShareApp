...
| <img src="docs/images/Home.png" alt="ホーム画面" width="200">        | **ホーム画面**<br>・部屋の一覧を確認<br>・状態ラベル(待機/作業/休憩)でフィルタリング<br>・部屋作成（公開/非公開の設定あり）<br>・人数やセッション数を表示<br>・ユーザーアイコンのフレームが活動量で変化 |
...
| <img src="docs/images/Space.png" alt="部屋画面" width="200">         | **部屋画面**<br>・画面上部にタイマー表示<br>・開始前は「開始まで○分○秒」を表示<br>・コメント投稿＆参加者一覧を表示<br>・バックグラウンド移行時に復帰を促す通知あり                                      |
